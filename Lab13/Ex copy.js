...
var user_regs_data = "./user_data.json";
...
<input type="submit" value="Submit" id="submit">
 ...
 app.post("/register", function (request, response) {
    ...
    user_regs_data[username] = {};
    user_regs_data[username].password = request.body.password;
    user_regs_data[username].email = request.body.email;
